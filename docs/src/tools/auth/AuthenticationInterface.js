...
class AuthenticationInterface {
    ...
    showAuthInterface = (nav, isLogged) => {
        ...
        if(isLogged){
            ...
            nav.innerHTML = btnToSingOut            
        } else {
            nav.innerHTML = btnToSingIn
            nav.innerHTML += 
            `<style>
            button.auth{
                width: 200px;
            ...
            button.fb{
                background-color: #4167B2; /*//rgb(65, 103, 178);*/
                color: white;
            }
            button.fb svg{
                background-color: #4167B2; /*//rgb(65, 103, 178);*/
    ...
    authentication = (isLogged) => {
        let nodeElement = document.querySelector('.auth')// CONTAINER
